...
export default function Divisas() {
    return (
        <div className="w-[80%] mt-16 mb-10">
            <div className="relative flex flex-col items-center justify-center rounded-md shadow-lg bg-white pt-8 pb-16">
                <p className="text-[25px] font-medium">Calculadora de divisas</p>
                <p className="text-[20px] text-[#2e3032] pt-3">Usa el conversor de divisas para conocer el tipo de cambio hoy</p>
                <div className="flex justify-between mt-4 w-[80%]">
                    <div className="flex flex-col items-center gap-4 py-8 px-3 w-[40%] shadow-xl border border-gray-100 rounded-md">
            ...
            <p className="text-gray-500 mt-12 text-center">El tipo de cambio es informativo y sujeto a cambios en sucursal</p>
        </div>
    )
}